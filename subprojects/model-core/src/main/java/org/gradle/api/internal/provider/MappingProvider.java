...
/**
 * <p>A mapping provider that uses a transform that 1. does not use the value contents and 2. always produces a value.
 * This implementation is used only for internal transforms where these constraints are known to be true.
