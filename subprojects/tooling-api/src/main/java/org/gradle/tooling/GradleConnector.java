...
public abstract class GradleConnector {
     ...
     *
     * <p>
     * Note, that the returned instance does not automatically pick up changes if the connection configuration (e.g. the gradle.properties file) changes. It's the client's responsibility to close and create a new connection in that scenario.
     *
